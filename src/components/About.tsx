  ...
  return (
    <div style={{ position: "relative", padding: "0 .5em" }}>
      <div style={{ maxWidth: "500px", margin: "0 auto" }}>
        <h1>About</h1>
        <p>Rebase is a new protocol for launching tokens. You start by selecting which token communities, e.g. $BUILD, to launch your token to. Holders of those tokens can then stake to earn your token.</p>
        ...
        <p>Whenever a new project token is launched on Rebase, a portion of its supply is reserved for people that stake $REFI on that project.</p>
        <h2>reTokens</h2>
